...
<div class="container">
		<div class="col-md-12">
			...
			<div class="dropdown">
			<a  style="display: ${mainishidden}" hidden="hidden" href="${pageContext.request.contextPath }/customerController/showCustomer.action" class="btn btn-success btn-primary pull-right">
			主&nbsp;&nbsp;列&nbsp;&nbsp;表
		    </a>
			</div>
				...
				<div class="panel-body">
					<div class="table table-responsive">
						<table class="table table-bordered table-hover">
							...
							<tbody>
								<c:forEach items="${pageInfo.list}" var="customer" varStatus="C">
									<tr>
	...
	$(function() {
		...
		$("#page").bootstrapPaginator({
			...
			onPageClicked: function(event, originalEvent, type, page) {
				$(window).attr("location","${pageContext.request.contextPath}/customerController/showFindCustomer.action?cname=${cus.name}&sex=${cus.sex}&phone=${cus.phone}&wxh=${cus.weixin}&test1=${cus.dateChange}&currentPage="+page);
			}
		});
	});
</script>
